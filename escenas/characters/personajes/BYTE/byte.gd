...
@export var fuerza: int = 3
@export var inteligencia: int = 9
@export var Velocidad_ataque : float = 7.0
@export var Velocidad_proyectil: float = 18.5
@export var Velocidad_movimiento: float = 12.8
@export var Probabilidad_crítico: float = 0.2
@export var Bateria_Portatil : PackedScene #Item Inicial,(activo)
var esta_activo_clase_rango: bool = false
var esta_activo_clase_mele: bool = false
var esta_activo_clase_mago: bool = false
var esta_activo_clase_invocador: bool = false
...
func obtener_costo_energia_actual() -> float:
	# Verificamos si el nodo del arma existe y si tiene la variable 'costo_energia'
	if $ArmaVisual and "costo_energia" in $ArmaVisual:
		return $ArmaVisual.costo_energia
	return 5.0 # Valor por defecto de respaldo
#------------------------------------------------------
