...
@export var escalado_inteligencia: float = 0.68  # 🧠 Porcentaje de Inteligencia (Ej: 0.68 = 68%)
@export var escalado_fuerza: float = 0.0        # 💪🏽 Porcentaje de Fuerza (Ej: 0.26 = 26%)
@export var cadencia_base: float = 0.7          # 🏹 Tiempo base entre disparos
@export var multiplicador_vel_proyectil: float = 1.0 # 🚀 Multiplicador de velocidad de la bala

# --- EXTRAS ---
@export var aplica_quemadura: bool = true
@export var duracion_quemadura: float = 2.0
