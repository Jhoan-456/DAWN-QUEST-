...
@export var frecuencia_onda: float = 10.0
@export var amplitud_onda: float = 80.0
...
func _physics_process(delta: float) -> void:
	# 🟢 Reduce la velocidad paulatinamente hacia 0
	velocidad = move_toward(velocidad, 0.0, desaceleracion * delta)
